...
public class PrivacyActivity extends AppCompatActivity {
    ...
    //final String webViewUrl = "https://service.alphado.co.kr/Policy/AlphaCare/";
    final String webFile = "/privacy.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(mContext.getResources().getString(R.string.menu_privacy));
